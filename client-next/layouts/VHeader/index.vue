<template>
  <div class="relative">
    <transition name="fade">
      <div v-show="true" class="fixed overflow-hidden w-full px-4 py-1 md:px-0 inset-0 md:h-[65px] h-[60px] text-slate-900 bg-white shadow duration-300 z-50 backdrop-blur-md">
