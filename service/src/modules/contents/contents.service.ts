...
export class ContentsService {
  constructor(
    ...
    private readonly contentRepository: EntityRepository<Content>, // @InjectRepository(Category) // private categoryRepository: EntityRepository<Category>, // @InjectRepository(Tag) // private tagRepository: EntityRepository<Tag>,
  ) {}
